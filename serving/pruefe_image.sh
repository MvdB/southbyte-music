...
# Stueck erzeugen, Kopfdaten pruefen, aufraeumen. Am Ende steht eine Aussage,
...
echo
echo "── 1/5  Architektur und Herkunft"
...
echo
echo "── 2/5  Laeuft nicht als root"
...
echo
echo "── 4/5  Ein Stueck erzeugen (${FRAMES} Frames)"
BEGONNEN=$SECONDS
...
echo
echo "── 5/5  Ist das wirklich Audio?"
